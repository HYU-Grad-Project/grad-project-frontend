...
<template>
  <div class="h-full">
    ...
    <div class="h-full">
      ...
      <div class="border-solid border-2 border-indigo-500 rounded-lg p-4 m-4">
        <div>
      ...
      <div class="bg-green-100 rounded-lg p-4 m-4 h-1/2">
        <div class="font-bold text-green-950">Pod List</div>
        <div
          v-if="monitorValues"
        ...
        >
          <div
            class="border-solid border-2 border-green-800 bg-white rounded-lg p-4 m-4"
          >
            <div>
